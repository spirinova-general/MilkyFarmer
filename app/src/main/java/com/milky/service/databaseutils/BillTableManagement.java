...
public class BillTableManagement {
    public static void insertBillData(SQLiteDatabase db, VCustomers holder) {
...
//        values.put(TableColumns.BALANCE, holder.getBalance_amount());
        ...
        values.put(TableColumns.TOTAL_AMOUNT, holder.getTotal());
...
//    }
    ...
    public static void updateBillMade(SQLiteDatabase db, String date, String bill, String custId) {
        ...
        long i = db.update(TableNames.TABLE_CUSTOMER_BILL, values, TableColumns.ID + " ='" + custId + "'" + " AND " + TableColumns.END_DATE + " >='" + date + "'"
                + " AND " + TableColumns.START_DATE + " <='" + date + "'", null);
    }

    public static void updateDeletedOn(SQLiteDatabase db, String custId) {
        ContentValues values = new ContentValues();
        ...
        long i = db.update(TableNames.TABLE_CUSTOMER_BILL, values, TableColumns.ID + " ='" + custId + "'"
                , null);
    }
...
//        values.put(TableColumns.DEFAULT_RATE, holder.getRate());
    ...
    public static void updateCurrentDateData(SQLiteDatabase db, VCustomers holder) {
        ...
        db.update(TableNames.TABLE_CUSTOMER_BILL, values, TableColumns.ID + " ='" + holder.getCustomerId() + "'"
    ...
    public static boolean isToBeOutstanding(SQLiteDatabase db, String custId, String day) {
        String selectQuery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE "
                + TableColumns.ID + " ='" + custId + "'" + " AND " + TableColumns.END_DATE + " ='" + day + "'";
        Cursor cursor = db.rawQuery(selectQuery, null);
        Boolean result = cursor.getCount() > 0;
        cursor.close();
        return result;
...
//    }
    ...
    public static float getPreviousBill(SQLiteDatabase db, final int custId, final String day, final double quantity) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.ID + " ='"
                + custId + "'"
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (cursor.getString(cursor.getColumnIndex(TableColumns.QUANTITY)) != null)
                    holder.setQuantity(cursor.getDouble(cursor.getColumnIndex(TableColumns.QUANTITY)));
    ...
    public static void updateOutstandingBills(SQLiteDatabase db, String quantity, String payment, String custId) {
        ...
        db.update(TableNames.TABLE_CUSTOMER_BILL, values, TableColumns.ID + " ='" + custId + "'" + " AND "
    ...
    public static ArrayList<VBill> getHistoryBills(SQLiteDatabase db, String custId) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE "
                + TableColumns.ID + " ='" + custId + "'" + " AND " + TableColumns.IS_OUTSTANDING + " ='" + "0'" + " AND "
    ...
    public static ArrayList<VBill> getTotalBillById(SQLiteDatabase db, String id) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.IS_CLEARED + " ='" + "1'"
                + " AND " + TableColumns.START_DATE + " <='" + Constants.getCurrentDate() + "'" + " AND " + TableColumns.END_DATE + " >='"
                + Constants.getCurrentDate() + "' AND " + TableColumns.IS_OUTSTANDING + " ='1' AND " + TableColumns.ID + " ='" + id + "'";
        ArrayList<VBill> list = new ArrayList<>();
        Cursor cursor = db.rawQuery(selectquery, null);
        if (cursor.moveToFirst()) {
            do {
...
//                list.add(holder);
    ...
    public static String getBillMade(SQLiteDatabase db, int custId, String deliveryStartDate) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.IS_CLEARED + " ='" + "1'"
                + " AND " + TableColumns.ID + " ='" + custId + "'" + " AND " + TableColumns.START_DATE + " <='" + Constants.getCurrentDate() + "'" + " AND " + TableColumns.END_DATE + " >='"
...
//                    holder.setQuantity(cursor.getString(cursor.getColumnIndex(TableColumns.QUANTITY)));
    ...
    public static String getOutstandingBillMade(SQLiteDatabase db, int custId, String deliveryStartDate) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.IS_CLEARED + " ='" + "1'"
                + " AND " + TableColumns.ID + " ='" + custId + "'" + " AND " + TableColumns.START_DATE + " <='" + deliveryStartDate + "'" + " AND " + TableColumns.END_DATE + " >='"
...
//                    holder.setQuantity(cursor.getString(cursor.getColumnIndex(TableColumns.QUANTITY)));
    ...
    public static String getStartDatebyCustomerId(SQLiteDatabase db, String custId) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.ID + " ='" + custId + "'"
...
//        values.put(TableColumns.DEFAULT_RATE, holder.getRate());
    ...
    public static double getBill(SQLiteDatabase db, final String custId, final String day) {
        String selectquery = "SELECT * FROM " + TableNames.TABLE_CUSTOMER_BILL + " WHERE " + TableColumns.ID + " ='"
