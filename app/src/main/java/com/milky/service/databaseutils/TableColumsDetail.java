...
public class TableColumsDetail {
    ...
    public static final String ACCOUNT = "CREATE TABLE " + TableNames.ACCOUNT + "("
            ...
            + TableColumns.Validated + " INTEGER," + TableColumns.ServerAccountId + " TEXT,"+TableColumns.IsDeleted+" INTEGER,"
            +TableColumns.Dirty+" INTEGER"+ ")";
    ...
    public static final String AREA = "CREATE TABLE " + TableNames.AREA + "(" + TableColumns.ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"
            + TableColumns.Locality + " TEXT,"+TableColumns.Name+" TEXT," + TableColumns.City + " TEXT," +  TableColumns.Dirty + " TEXT,"+TableColumns.IsDeleted+" INTEGER,"
            +TableColumns.DateModified+" DATETIME" + ")";
    ...
    public static final String CUSTOMER = "CREATE TABLE " + TableNames.CUSTOMER + "(" + TableColumns.ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," + TableColumns.FirstName + " TEXT,"
            ...
            + TableColumns.DateAdded + " DATETIME," + TableColumns.StartDate + " DATETIME," + TableColumns.AreaId + " INTEGER,"+ TableColumns.DeletedOn + " INTEGER," +TableColumns.IsDeleted+" INTEGER,"
            +TableColumns.Dirty+" INTEGER,"+TableColumns.DateModified+" DATETIME" + " ,FOREIGN KEY (" + TableColumns.AreaId + ") REFERENCES " + TableNames.AREA + "(" + TableColumns.ID + ")" +
            ")";
    ...
    public static final String CUSTOMERS_BILL = "CREATE TABLE " + TableNames.Bill + "(" + TableColumns.ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL," + TableColumns.StartDate + " DATETIME," + TableColumns.EndDate + " DATETIME,"
            ...
            + TableColumns.PaymentMade + " REAL," + TableColumns.IsOutstanding + " INTEGER," + TableColumns.TotalAmount + " REAL," + TableColumns.DateAdded + " DATETIME,"+ TableColumns.CustomerId + " INTEGER,"+TableColumns.IsDeleted+" INTEGER,"
            +TableColumns.Dirty+" INTEGER,"+TableColumns.DateModified+" DATETIME,"  + " FOREIGN KEY (" + TableColumns.CustomerId + ")" + " REFERENCES " + TableNames.CUSTOMER + "(" + TableColumns.ID + ")" + ")";
